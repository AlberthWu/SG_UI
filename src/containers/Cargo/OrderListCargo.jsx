    ...
    return (
        <div>
            <div className="card p-fluid">
                ...
                <Fragment>
                     <ListTableComp api={true} history={history} loading={isLoading} title={title} scrollHeight="500px"
...
export default React.memo(OrderListCargo, comparisonFn);